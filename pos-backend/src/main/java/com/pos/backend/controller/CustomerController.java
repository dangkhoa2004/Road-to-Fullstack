...
public class CustomerController {
    ...
    public ResponseEntity<ApiResponse<List<CustomerResponse>>> getAllCustomers() {
        ...
        ApiResponse<List<CustomerResponse>> apiResponse = new ApiResponse<>("Lấy danh sách khách hàng thành công",
                "200", customers);
    ...
    public ResponseEntity<ApiResponse<CustomerResponse>> getCustomerById(@PathVariable Long id) {
        try {
            ...
            ApiResponse<CustomerResponse> apiResponse = new ApiResponse<>("Lấy thông tin khách hàng thành công", "200",
                    customer);
            return ResponseEntity.ok(apiResponse);
        } catch (NoSuchElementException e) {
            ApiResponse<CustomerResponse> errorResponse = new ApiResponse<>("Không tìm thấy khách hàng với ID: " + id,
                    "404", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
        } catch (Exception e) {
            ApiResponse<CustomerResponse> errorResponse = new ApiResponse<>(
                    "Có lỗi xảy ra khi lấy khách hàng: " + e.getMessage(), "500", null);
    ...
    public ResponseEntity<ApiResponse<CustomerResponse>> createCustomer(
        ...
        try {
            ...
            ApiResponse<CustomerResponse> apiResponse = new ApiResponse<>("Tạo khách hàng thành công", "201",
                    createdCustomer);
            ...
            ApiResponse<CustomerResponse> errorResponse = new ApiResponse<>("Số điện thoại hoặc Email đã tồn tại.",
                    "409", null); // 409 Conflict
            return new ResponseEntity<>(errorResponse, HttpStatus.CONFLICT);
        } catch (Exception e) {
            ApiResponse<CustomerResponse> errorResponse = new ApiResponse<>(
                    "Tạo khách hàng thất bại: " + e.getMessage(), "500", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<ApiResponse<CustomerResponse>> updateCustomer(@PathVariable Long id,
        ...
        try {
            ...
            ApiResponse<CustomerResponse> errorResponse = new ApiResponse<>(
                    "Không tìm thấy khách hàng để cập nhật với ID: " + id, "404", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
        } catch (IllegalArgumentException e) {
            ApiResponse<CustomerResponse> errorResponse = new ApiResponse<>(e.getMessage(), "400", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
            ...
            ApiResponse<CustomerResponse> errorResponse = new ApiResponse<>(
                    "Cập nhật khách hàng thất bại: " + e.getMessage(), "500", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deleteCustomer(@PathVariable Long id) {
        try {
            ...
            ApiResponse<Void> errorResponse = new ApiResponse<>("Không tìm thấy khách hàng để xóa với ID: " + id, "404",
                    null);
            return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
        } catch (Exception e) {
            ApiResponse<Void> errorResponse = new ApiResponse<>("Xóa khách hàng thất bại: " + e.getMessage(), "500",
                    null);
            return new ResponseEntity<>(errorResponse, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
