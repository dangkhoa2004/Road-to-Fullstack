...
public class TableController {
    ...
    public ResponseEntity<ApiResponse<List<TableResponse>>> getAllTables() {
        try {
            ...
            ApiResponse<List<TableResponse>> apiResponse = new ApiResponse<>("Lấy danh sách bàn thành công", "200", tables);
            return ResponseEntity.ok(apiResponse);
        } catch (Exception e) {
            ApiResponse<List<TableResponse>> errorResponse = new ApiResponse<>("Có lỗi xảy ra khi lấy danh sách bàn: " + e.getMessage(), "500", null);
    ...
    public ResponseEntity<ApiResponse<TableResponse>> getTableById(@PathVariable Long id) {
        try {
            ...
            ApiResponse<TableResponse> errorResponse = new ApiResponse<>("Không tìm thấy bàn với ID: " + id, "404", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
        } catch (Exception e) {
            ApiResponse<TableResponse> errorResponse = new ApiResponse<>("Có lỗi xảy ra khi lấy bàn: " + e.getMessage(), "500", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<ApiResponse<TableResponse>> createTable(@Valid @RequestBody TableRequest request) {
        try {
            ...
            ApiResponse<TableResponse> errorResponse = new ApiResponse<>("Dữ liệu đầu vào vi phạm ràng buộc.", "409", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.CONFLICT);
        } catch (Exception e) {
            ApiResponse<TableResponse> errorResponse = new ApiResponse<>("Tạo bàn thất bại: " + e.getMessage(), "500", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<ApiResponse<TableResponse>> updateTable(@PathVariable Long id, @Valid @RequestBody TableRequest request) {
        try {
            ...
            ApiResponse<TableResponse> errorResponse = new ApiResponse<>("Không tìm thấy bàn để cập nhật với ID: " + id, "404", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
        } catch (IllegalArgumentException e) {
            ApiResponse<TableResponse> errorResponse = new ApiResponse<>(e.getMessage(), "400", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
            ...
            ApiResponse<TableResponse> errorResponse = new ApiResponse<>("Cập nhật bàn thất bại: " + e.getMessage(), "500", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<ApiResponse<TableResponse>> updateTableStatus(@PathVariable Long id, @RequestParam Tables.TableStatus status) {
        try {
            TableResponse updatedTable = tableService.updateStatus(id, status);
            ApiResponse<TableResponse> apiResponse = new ApiResponse<>("Cập nhật trạng thái bàn thành công", "200", updatedTable);
            return ResponseEntity.ok(apiResponse);
        } catch (NoSuchElementException e) {
            ApiResponse<TableResponse> errorResponse = new ApiResponse<>("Không tìm thấy bàn để cập nhật với ID: " + id, "404", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
        } catch (Exception e) {
            ApiResponse<TableResponse> errorResponse = new ApiResponse<>("Cập nhật trạng thái bàn thất bại: " + e.getMessage(), "500", null);
            return new ResponseEntity<>(errorResponse, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
