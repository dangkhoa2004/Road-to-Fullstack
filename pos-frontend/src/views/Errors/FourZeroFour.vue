<template>
  <div
    ...
    <div class="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
      ...
      <img alt="404" class="dark:hidden" src="/images/error/404.svg"/>
      <img alt="404" class="hidden dark:block" src="/images/error/404-dark.svg"/>
      ...
      <router-link class="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-5 py-3.5 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
                   to="/">
        Quay lại trang chủ
      </router-link>
    </div>
