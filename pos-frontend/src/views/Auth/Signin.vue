              ...
              <div>
                ...
                <div class="relative py-3 sm:py-5">
                  ...
                  <div class="relative flex justify-center text-sm">
                    <span
                      class="p-2 text-gray-400 bg-white dark:bg-gray-900 sm:px-5 sm:py-2">Hoặc</span>
                  </div>
                </div>
                  ...
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <div class="relative">
                        ...
                        <span class="absolute z-30 text-gray-500 -translate-y-1/2 cursor-pointer right-4 top-1/2 dark:text-gray-400"
                              @click="togglePasswordVisibility">
                          <svg v-if="!showPassword" class="fill-current" fill="none" height="20"
                               viewBox="0 0 20 20"
                          ...
                          <svg v-else class="fill-current" fill="none" height="20"
                    ...
                    <div class="flex items-center justify-between">
                      <div>
                        <label class="flex items-center text-sm font-normal text-gray-700 cursor-pointer select-none dark:text-gray-400"
                               for="keepLoggedIn">
                          <div class="relative">
                            <input id="keepLoggedIn" v-model="keepLoggedIn" class="sr-only"
                                   type="checkbox"/>
                ...
                <div class="mt-5">
                  <p
                    ...
                    Chưa có tài khoản?
                    <router-link class="text-brand-500 hover:text-brand-600 dark:text-brand-400"
                                 to="/dang-ky">
                      Đăng
                      ký
                    </router-link>
...
const loginAction = (payload: { username: string; password: string }) => {
  return store.dispatch('auth/' + types.LOGIN, payload)
}
...
const handleSubmit = async () => {
  if (!username.value || !password.value) {
    store.commit('auth/' + types.SET_AUTH_ERROR, 'Vui lòng nhập cả tên người dùng và mật khẩu.')
    return
  }
  try {
    await loginAction({
