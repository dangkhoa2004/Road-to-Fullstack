        ...
        <ol class="relative border-s border-gray-200 dark:border-gray-600 ms-3.5 mb-4 md:mb-5">
          <li class="mb-10 ms-8">
                        <span
                            ...
                            <svg aria-hidden="true" class="w-2.5 h-2.5 text-gray-500 dark:text-gray-400"
            ...
            <h3 class="flex items-start mb-1 text-lg font-semibold text-gray-900 dark:text-white">
              Giao diện ứng dụng RTFS v2.0.0 <span
                class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded-sm dark:bg-blue-900 dark:text-blue-300 ms-3">Mới nhất</span>
            </h3>
            <time
                class="block mb-3 text-sm font-normal leading-none text-gray-500 dark:text-gray-400">Phát hành
              on Nov 10th, 2023
            </time>
            <button class="py-2 px-3 inline-flex items-center text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                    type="button">
              <svg aria-hidden="true" class="w-3 h-3 me-1.5" fill="currentColor"
          ...
          <li class="mb-10 ms-8">
            ...
            <h3 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">RTFS Figma
              v2.8.0</h3>
            <time
                class="block mb-3 text-sm font-normal leading-none text-gray-500 dark:text-gray-400">Đã phát hành
              vào ngày 7 tháng 10 năm 2023
            </time>
            <button class="py-2 px-3 inline-flex items-center text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                    type="button">
              <svg aria-hidden="true" class="w-3 h-3 me-1.5" fill="none" viewBox="0 0 30 45"
          ...
          <li class="ms-8">
            ...
            <h3 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Thư viện RTFS
              v1.2.2</h3>
            <time
                class="block mb-3 text-sm font-normal leading-none text-gray-500 dark:text-gray-400">Đã phát hành
              vào ngày 2 tháng 12 năm 2021
            </time>
          </li>
        </ol>
        <button
...
<script>
export default {
  name: 'TimelineApplication',
  setup() {
    // Any specific logic for this component can go here
  }
}
</script>