    ...
    <div class="container mx-auto p-5">
        ...
        <div v-else-if="product" class="bg-white shadow-lg rounded-lg overflow-hidden md:flex">
            ...
            <div class="md:w-1/2 p-6">
                ...
                <p class="text-gray-600 text-sm mb-4">ID: {{ product.id }} | Barcode: {{ product.barcode || 'N/A' }}</p>
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-700 text-lg">
                        <span class="font-semibold">Quantity:</span> {{ product.quantity || 0 }}
                    </p>
                    <p class="text-gray-700 text-lg">
                        <span class="font-semibold">Category:</span> {{ product.categoryName || 'N/A' }}
                    </p>
                </div>

                <div class="text-sm text-gray-500 mb-4">
                    <p>Created At: {{ product.createdAt ? new Date(product.createdAt).toLocaleDateString('en-US') :
                        'N/A' }}</p>
                    <p>Updated At: {{ product.updatedAt ? new Date(product.updatedAt).toLocaleDateString('en-US') :
                        'N/A' }}</p>
                </div>
