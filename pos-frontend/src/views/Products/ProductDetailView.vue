  ...
  <div class="container mx-auto pl-5 pr-5">
    ...
    <div v-else-if="product" class="bg-white shadow-lg rounded-lg overflow-hidden md:flex">
      <div class="md:w-1/2 p-4 flex justify-center items-center ">
        <img :alt="product.name" :src="product.imagePath || 'No+Image'" class="max-h-96 object-contain"/>
      </div>
      <div class="md:w-1/2 p-6">
        ...
        <div class="flex gap-4 mt-6">
          <button class="flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  @click="editProduct(product.id)">
            <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" stroke-width="1.5"
                 viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" stroke-linecap="round"
                    stroke-linejoin="round"/>
            </svg>
            Chỉnh sửa sản phẩm
          </button>
          <button class="flex items-center px-4 py-2 bg-gray-300 text-gray-800 rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                  @click="goBack">
            <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" stroke-width="1.5"
                 viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3" stroke-linecap="round"
                    stroke-linejoin="round"/>
            </svg>
