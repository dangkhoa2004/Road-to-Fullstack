<template>
  <div
    ...
    <a href="#">
      <img alt="product image" class="p-8 rounded-t-lg" src="/docs/images/products/apple-watch.png"/>
    </a>
    <div class="px-5 pb-5">
      <a href="#">
      ...
      <div class="flex items-center mt-2.5 mb-5">
        <div class="flex items-center space-x-1 rtl:space-x-reverse">
          <svg aria-hidden="true" class="w-4 h-4 text-yellow-300" fill="currentColor"
          ...
          <svg aria-hidden="true" class="w-4 h-4 text-gray-200 dark:text-gray-600"
