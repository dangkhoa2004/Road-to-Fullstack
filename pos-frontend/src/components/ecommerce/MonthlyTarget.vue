  ...
  <div
    ...
    <div
      ...
      <div class="flex justify-between">
        <div>
          <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Mục tiêu tháng</h3>
          ...
          <DropdownMenu :menu-items="menuItems">
            <template #icon>
              <svg fill="none" height="24" viewBox="0 0 24 24" width="24"
                ...
                <path clipRule="evenodd" d="M10.2441 6C10.2441 5.0335 11.0276 4.25 11.9941 4.25H12.0041C12.9706 4.25 13.7541 5.0335 13.7541 6C13.7541 6.9665 12.9706 7.75 12.0041 7.75H11.9941C11.0276 7.75 10.2441 6.9665 10.2441 6ZM10.2441 18C10.2441 17.0335 11.0276 16.25 11.9941 16.25H12.0041C12.9706 16.25 13.7541 17.0335 13.7541 18C13.7541 18.9665 12.9706 19.75 12.0041 19.75H11.9941C11.0276 19.75 10.2441 18.9665 10.2441 18ZM11.9941 10.25C11.0276 10.25 10.2441 11.0335 10.2441 12C10.2441 12.9665 11.0276 13.75 11.9941 13.75H12.0041C12.9706 13.75 13.7541 12.9665 13.7541 12C13.7541 11.0335 12.9706 10.25 12.0041 10.25H11.9941Z"
                      fill="currentColor"
                      fillRule="evenodd"/>
              </svg>
            </template>
      ...
      <div class="relative max-h-[195px]">
        <div id="chartTwo" class="h-full">
          <div class="radial-bar-chart">
            <VueApexCharts :options="chartOptions" :series="series" height="330" type="radialBar"/>
          </div>
        </div>
        <span
      ...
      <p class="mx-auto mt-1.5 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
        Hôm nay bạn kiếm được 3.287.000 VNĐ, cao hơn tháng trước. Hãy tiếp tục làm tốt công việc của
        bạn!
      </p>
    </div>
    ...
    <div class="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5">
      <div>
        ...
        <p
          class="flex items-center justify-center gap-1 text-xs font-semibold text-gray-800 dark:text-white/90 sm:text-lg">
          20.000.000 <span class="text-xs">VNĐ</span>
...
const menuItems = [
  {label: 'Xem thêm', onClick: () => console.log('Đã chọn Xem thêm')},
  {label: 'Xoá', onClick: () => console.log('Đã chọn Xoá')},
]
