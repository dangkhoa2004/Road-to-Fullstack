<template>
  <div
    ...
    <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
      <div>
        <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Đơn hàng gần đây</h3>
      </div>

      <div class="flex items-center gap-3">
        <button
          class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
          <svg class="stroke-current fill-white dark:fill-gray-800" fill="none" height="20"
               viewBox="0 0 20 20"
               width="20" xmlns="http://www.w3.org/2000/svg">
            <path d="M2.29004 5.90393H17.7067" stroke="" stroke-linecap="round" stroke-linejoin="round"
                  stroke-width="1.5"/>
            <path d="M17.7075 14.0961H2.29085" stroke="" stroke-linecap="round" stroke-linejoin="round"
                  stroke-width="1.5"/>
            <path
          ...
          <td class="py-3 whitespace-nowrap">
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <span class="text-gray-500 text-theme-xs dark:text-gray-400">{{ product.variants }} sản phẩm</span>
              </div>
            </div>
          </td>
          <td class="py-3 whitespace-nowrap">
